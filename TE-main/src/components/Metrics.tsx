    ...
    <div className="flex flex-col h-full overflow-auto">
      ...
      <div className="grid grid-cols-2 gap-3 p-4 flex-1 overflow-y-auto" style={{ minHeight: 0 }}>
        {displayMetrics.map((m, i) => (
          <div key={i} className="bg-gradient-to-br from-purple-50 to-indigo-50 border border-dash-line p-4 rounded-xl flex flex-col justify-between hover:shadow-md transition-shadow group">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-dash-muted group-hover:text-dash-accent">
                {m.label}
              </span>
              <div className="p-1.5 bg-white rounded-lg text-dash-muted group-hover:text-dash-accent shadow-sm">
                {m.icon}
              </div>
            </div>
            <div className="mt-3">
        ...
        <div className="col-span-2 bg-gradient-to-br from-blue-50 to-purple-50 border border-dash-line p-4 rounded-xl mt-1">
           <h3 className="text-xs font-semibold text-dash-text mb-3">Retrieval Performance</h3>
           <div className="space-y-3">
              <div className="space-y-1.5">
                 <div className="flex justify-between text-xs">
                    <span className="text-dash-muted font-medium">Vector Search</span>
              ...
              <div className="space-y-1.5">
                 <div className="flex justify-between text-xs">
                    <span className="text-dash-muted font-medium">Graph Grounding</span>
