                      ...
                      <div className="space-y-1.5">
                        {msg.initialRanking.map((source, si) => (
                          <div key={si} className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 border border-blue-200 text-xs">
                            ...
                            <span className="flex-1 truncate text-dash-text">{source.filename}</span>
      ...
      <div className="p-4 border-t border-dash-line bg-dash-surface">
        <div className="relative">
          <input
            ...
            className="w-full bg-white border border-dash-line rounded-xl py-3 pl-4 pr-14 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all placeholder:text-dash-muted"
          />
          <button 
            onClick={handleSend}
